...
> Observação: esta versão gera o boxplot em imagem SVG usando apenas biblioteca padrão do Python.
...
### O que foi feito
- Dois box plots lado a lado em um único arquivo de imagem SVG:
  - `wtkg` por `infected`
  - `age` por `infected`
- Arquivo gerado: `outputs/desafio2_boxplots.svg` (imagem)
